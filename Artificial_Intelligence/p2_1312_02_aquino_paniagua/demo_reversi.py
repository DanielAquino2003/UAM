...
from p2_1312_02_aquino_paniagua import Solution1 # import your StudentHeuristic here
...
# The line `# Manual vs manual player` is a comment that indicates that the following lines of code
# are used to set up a match between two manual players.
