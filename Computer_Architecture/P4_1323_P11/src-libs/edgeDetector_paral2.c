...
int main(int nargs, char **argv)
{
    ...
    for (int file_i = 1; file_i < nargs; file_i++)
    {
        ...
        printf("[info] Processing %s - threadid=%d\n", argv[file_i], threadid);
        /****** Reading file ******/
        ...
        /****** Computations ******/
        printf("[info] %s: width=%d, height=%d, nchannels=%d, threadid=%d\n", argv[file_i], width, height, nchannels, threadid);
